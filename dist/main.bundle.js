    ...
    LoginComponent.prototype.login = function () {
        ...
        this.userService.findUserByCredentials(this.username, this.password)
            ...
            if (user) {
                ...
                _this.loginError = 'Invalid Username/ Password. Try again...';
            }
        });
    };
        ...
        if (password === passwordDuplicated) {
            this.userService.findUserByUsername(username)
                ...
                if (data1) {
                    ...
                    var user_1 = new __WEBPACK_IMPORTED_MODULE_3__model_user_model_client__["a" /* User */](null, username, password, null, null, null);
                    _this.userService.createUser(user_1)
                        .subscribe(function (data) {
                        user_1 = data;
                        console.log(user_1);
                        _this.router.navigate(['/user', user_1._id]);
                    });
                }
            });
        }
...
var WidgetTextComponent = (function () {
        ...
        this.activatedRoute.params.subscribe(function (params) {
            ...
            if (_this.widgetId) {
                ...
                _this.widgetService.findWidgetById(_this.widgetId)
                    ...
                    if (data) {
                        _this.editWidget = data;
                        _this.isFormatted = _this.editWidget.isFormatted;
    ...
    WidgetTextComponent.prototype.updateWidget = function () {
        ...
        if (this.isNewWidget) {
            var widget = { '_id': null, 'widgetType': 'TEXT', 'pageId': this.pageId,
